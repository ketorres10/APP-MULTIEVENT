...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentesEventosDetailSubeventDetailSubeventPageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-header>\n  <ion-toolbar>\n    <ion-title>Subeventos</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div class=\"container\" *ngIf=\"subevent$ | async as subevent;\">\n    <ion-card>\n      <ion-card-header>\n        <ion-card-subtitle>{{subevent.siglas}}</ion-card-subtitle>\n        <ion-card-title>\n          {{subevent.title}}\n        </ion-card-title>\n      </ion-card-header>\n      <ion-card-content>\n        {{subevent.descrip}}\n      </ion-card-content>\n      <ion-item-divider></ion-item-divider>\n      <h4>&nbsp;Topicos de Interés</h4>\n      <ion-card-content selected *ngFor=\"let topic of subevent.topics\" [ngClass]=\"topic\">\n        {{topic}}\n      </ion-card-content>\n      <ion-button (click)=\"onLogout()\">Añadir</ion-button>\n    </ion-card>\n  </div>\n</ion-content>\n";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | componentes-cerrar-cerrar-module */
        "componentes-cerrar-cerrar-module").then(__webpack_require__.bind(null,
        /*! ./componentes/cerrar/cerrar.module */
        "./src/app/componentes/cerrar/cerrar.module.ts")).then(function (m) {
          return m.CerrarPageModule;
        });
      },
      canActivate: [_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }];
  ...
  function srcAppAppComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-menu ion-content {\n  --background: var(--ion-item-background, var(--ion-background-color,#002d5c));\n}\n\nion-menu.md ion-content {\n  --padding-start: 8px;\n  --padding-end: 8px;\n  --padding-top: 20px;\n  --padding-bottom: 20px;\n}\n\nion-menu.md ion-list {\n  padding: 20px 0;\n}\n\nion-menu.md ion-note {\n  margin-bottom: 30px;\n}\n\nion-menu.md ion-list-header,\nion-menu.md ion-note {\n  padding-left: 10px;\n}\n\nion-menu.md ion-list#inbox-list {\n  border-bottom: 1px solid var(--ion-color-step-150, #D4AC0D);\n}\n\nion-menu.md ion-list#inbox-list ion-list-header {\n  font-size: 22px;\n  font-weight: 600;\n  min-height: 20px;\n}\n\nion-menu.md ion-list#labels-list ion-list-header {\n  font-size: 16px;\n  margin-bottom: 18px;\n  color: #757575;\n  min-height: 26px;\n}\n\nion-menu.md ion-item {\n  --padding-start: 10px;\n  --padding-end: 10px;\n  border-radius: 4px;\n}\n\nion-menu.md ion-item.selected {\n  --background: rgba(var(--ion-color-#ff2121-rgb), 0.20);\n}\n\nion-menu.md ion-item.selected ion-icon {\n  color: #ff2121;\n}\n\nion-menu.md ion-item ion-icon {\n  color: #030303;\n}\n\nion-menu.md ion-item ion-label {\n  font-weight: 500;\n}\n\nion-menu.ios ion-content {\n  --padding-bottom: 20px;\n}\n\nion-menu.ios ion-list {\n  padding: 20px 0 0 0;\n}\n\nion-menu.ios ion-note {\n  line-height: 24px;\n  margin-bottom: 20px;\n}\n\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --padding-end: 16px;\n  --min-height: 50px;\n}\n\nion-menu.ios ion-item.selected ion-icon {\n  color: var(--ion-color-danger);\n}\n\nion-menu.ios ion-item ion-icon {\n  font-size: 24px;\n  color: black;\n}\n\nion-menu.ios ion-list#labels-list ion-list-header {\n  margin-bottom: 8px;\n}\n\nion-menu.ios ion-list-header,\nion-menu.ios ion-note {\n  padding-left: 16px;\n  padding-right: 16px;\n}\n\nion-menu.ios ion-note {\n  margin-bottom: 8px;\n}\n\nion-note {\n  display: inline-block;\n  font-size: 16px;\n  color: black;\n}\n\nion-item.selected {\n  color: black;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppComponentesEventosDetailSubeventDetailSubeventPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudGVzL2V2ZW50b3MvZGV0YWlsLXN1YmV2ZW50L2RldGFpbC1zdWJldmVudC5wYWdlLnNjc3MifQ== */";
    /***/
  },
  ...
  function srcAppComponentesEventosDetailSubeventDetailSubeventPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DetailSubeventPage = /*#__PURE__*/function () {
      function DetailSubeventPage(route, eventoService, alertCtrl, authservice) {
  ...
  function srcAppComponentesEventosMoreinformationMoreinformationPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudGVzL2V2ZW50b3MvbW9yZWluZm9ybWF0aW9uL21vcmVpbmZvcm1hdGlvbi5wYWdlLnNjc3MifQ== */";
    /***/
  },
  ...
  function srcAppComponentesEventosMoreinformationMoreinformationPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MoreinformationPage = /*#__PURE__*/function () {
      function MoreinformationPage(authService, eventoService, route) {
      ...
      _createClass(MoreinformationPage, [{
        ...
        value: function ngOnInit() {
          ...
          var idEvent = this.route.snapshot.params.id;
          this.event$ = this.eventoService.getOneEvent(idEvent);
          this.event$.subscribe(function (event) {
            if (event.idSubevents != 0) {
              console.log(event);
              event.id = _this3.idEvent;
              event.idSubevents.forEach(function (element) {
                console.log(element, "elemento");
                _this3.subevent$ = _this3.eventoService.getOneSubEvent(element);

                var subscripSub = _this3.subevent$.subscribe(function (subevent) {
                  //console.log('sala id antes de beacon: ', subevent.sala)
                  var salaid = subevent.sala;
                  _this3.beacon$ = _this3.eventoService.getBeacon(subevent.sala);

                  var subscription = _this3.beacon$.subscribe(function (res) {
                    ...
                    _this3.subeventList.push(subeventObj); //this.dataSource.data = this.subeventList;
        ...
        value: function canActivate(next, state) {
          ...
          return this.AFauth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (auth) {
            ...
            if (Object(util__WEBPACK_IMPORTED_MODULE_5__["isNullOrUndefined"])(auth)) {
              ...
              _this4.router.navigate(['\folder']); //si no esta autenticado retorna false
        ...
        value: function canActivate(next, state) {
          ...
          return this.AFauth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (auth) {
            ...
            if (Object(util__WEBPACK_IMPORTED_MODULE_5__["isNullOrUndefined"])(auth)) {
              ...
              //redireccion al router
              _this5.router.navigate(['\eventos']); //si esta autenticado
      ...
      _createClass(AuthService, [{
        ...
        value: function login(email, password) {
          ...
          return new Promise(function (resolve, rejected) {
            _this6.AFauth.signInWithEmailAndPassword(email, password).then(function (user) {
        ...
        value: function logout() {
          ...
          this.AFauth.signOut().then(function (auth) {
            _this7.router.navigate(['/folder/Inicio']);
          });
        ...
        value: function register(user) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this8.AFauth.createUserWithEmailAndPassword(user.email, user.password).then(function (res) {
              //console.log(res.user.uid);
              var uid = res.user.uid; //apuntar a la base de datos

              _this8.db.collection('users').doc(uid).set({
                name: user.name,
  ...
  function srcAppSharedServiciosEventoServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! rxjs/operators */
    "./node_modules/rxjs/_esm2015/operators/index.js"); //importar Firestore


    var EventosService = /*#__PURE__*/function () {
      function EventosService(db) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\karee\Desktop\PROJECTO IONIC TT\gestionEventos\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
