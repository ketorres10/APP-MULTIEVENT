...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | componentes-informacion-informacion-module */
        "componentes-informacion-informacion-module").then(__webpack_require__.bind(null,
        /*! ./componentes/informacion/informacion.module */
        "./src/app/componentes/informacion/informacion.module.ts")).then(function (m) {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_servicios_auth_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./shared/servicios/auth.service */
    "./src/app/shared/servicios/auth.service.ts");

    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(platform, splashScreen, statusBar, menu, AFauth, navController, alertCtrl, authSvc) {
  ...
  function srcAppComponentesEventosDetailSubeventDetailSubeventPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DetailSubeventPage = /*#__PURE__*/function () {
      function DetailSubeventPage(route, eventoService, alertCtrl, authservice, beaconService, auth, navController) {
  ...
  function srcAppComponentesEventosMoreinformationMoreinformationPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MoreinformationPage = /*#__PURE__*/function () {
      function MoreinformationPage(authService, eventoService, route, auth, alertCtrl, beaconService, navController) {
        ...
        this.mostrar = true;
        this.subeventList = [];
        this.band = true; //obtener los datos del usuario autenticados
        ...
        value: function login(email, password) {
          ...
          return new Promise(function (resolve, rejected) {
            _this10.AFauth.signInWithEmailAndPassword(email, password).then(function (user) {
              ...
              localStorage.setItem("expiration", expirationDate.toISOString()); //caso contrario error
            })["catch"](function (err) {
              return rejected(err);
            });
          });
  ...
  function srcAppSharedServiciosEventoServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EventosService = /*#__PURE__*/function () {
      ...
      _createClass(EventosService, [{
        ...
        key: "deleteOnSubEvent",
        value: function deleteOnSubEvent(id, idsub) {
          var eventRef = this.db.collection('subevents').doc(idsub);
          console.log(eventRef);
          var val = eventRef.update({
            idUsers: firebase_app__WEBPACK_IMPORTED_MODULE_5__["firestore"].FieldValue.arrayRemove(id)
          });
