...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-app >\n  <ion-menu side=\"start\"  type=\"overlay\" contentId=\"main\" swipe-gesture=\"false\" color=\"primary\">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>Menu de opciones</ion-title>\n      </ion-toolbar>\n    </ion-header>\n    <ion-content >\n      <div class=\"container-imagen\">\n      </div>\n      <div class=\"container-actividades\">\n        <div class=\"hover\">\n          <ion-note (click)=\"inicio()\" class=\"actividad\" expand=\"full\"> <ion-icon name=\"home\"></ion-icon>&nbsp;&nbsp;Inicio</ion-note><br>\n        </div>\n        \n        <ion-note (click)=\"login()\" class=\"actividad\"> <ion-icon name=\"people\"></ion-icon>&nbsp;&nbsp;Iniciar sesión</ion-note><br>\n        <ion-note (click)=\"perfil()\" class=\"actividad\"> <ion-icon name=\"people\"></ion-icon>&nbsp;&nbsp;Perfil de usuario</ion-note><br>\n        <ion-note (click)=\"irEventos()\" class=\"actividad\"><ion-icon name=\"reader\"></ion-icon>&nbsp;&nbsp;Eventos</ion-note><br>\n        <ion-note (click)=\"agenda()\" class=\"actividad\"> <ion-icon name=\"calendar\"></ion-icon>&nbsp;&nbsp;Agenda</ion-note><br>\n        <ion-note (click)=\"deteccion()\" class=\"actividad\"> <ion-icon name=\"radio\"></ion-icon>&nbsp;&nbsp;Detección</ion-note><br>\n        <ion-note (click)=\"cerrarSesion()\" class=\"actividad\"> <ion-icon name=\"log-out\"></ion-icon>&nbsp;&nbsp;Cerrar sesión</ion-note>\n      </div>\n    </ion-content>\n  </ion-menu>\n  <ion-router-outlet id=\"main\"></ion-router-outlet>\n</ion-app>\n");
...
const routes = [
    ...
    {
        path: 'eventos',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-eventos-eventos-module */ "componentes-eventos-eventos-module").then(__webpack_require__.bind(null, /*! ./componentes/eventos/eventos.module */ "./src/app/componentes/eventos/eventos.module.ts")).then(m => m.EventosPageModule)
    },
    {
    ...
    {
        path: 'deteccion',
        loadChildren: () => __webpack_require__.e(/*! import() | componentes-deteccion-deteccion-module */ "componentes-deteccion-deteccion-module").then(__webpack_require__.bind(null, /*! ./componentes/deteccion/deteccion.module */ "./src/app/componentes/deteccion/deteccion.module.ts")).then(m => m.DeteccionPageModule)
    },
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("ion-menu ion-content {\n  --background: var(--ion-item-background, var(--ion-background-color,white));\n}\n\nion-menu.md ion-content {\n  --padding-start: 8px;\n  --padding-end: 8px;\n  --padding-top: 20px;\n  --padding-bottom: 20px;\n}\n\nion-menu.md ion-list {\n  padding: 20px 0;\n}\n\nion-menu.md ion-note {\n  margin-bottom: 30px;\n}\n\nion-menu.md ion-list-header,\nion-menu.md ion-note {\n  padding-left: 10px;\n}\n\nion-menu.md ion-list#inbox-list {\n  border-bottom: 1px solid var(--ion-color-step-150, #D4AC0D);\n}\n\nion-menu.md ion-list#inbox-list ion-list-header {\n  font-size: 22px;\n  font-weight: 600;\n  min-height: 20px;\n}\n\nion-menu.md ion-list#labels-list ion-list-header {\n  font-size: 16px;\n  margin-bottom: 18px;\n  color: #757575;\n  min-height: 26px;\n}\n\nion-menu.md ion-item {\n  --padding-start: 10px;\n  --padding-end: 10px;\n  border-radius: 4px;\n}\n\nion-menu.md ion-item.selected {\n  --background: rgba(var(--ion-color-#ff2121-rgb), 0.20);\n}\n\nion-menu.md ion-item.selected ion-icon {\n  color: #ff2121;\n}\n\nion-menu.md ion-item ion-icon {\n  color: #030303;\n}\n\nion-menu.md ion-item ion-label {\n  font-weight: 500;\n}\n\nion-menu.ios ion-content {\n  --padding-bottom: 20px;\n}\n\nion-menu.ios ion-list {\n  padding: 20px 0 0 0;\n}\n\nion-menu.ios ion-note {\n  line-height: 24px;\n  margin-bottom: 20px;\n}\n\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --padding-end: 16px;\n  --min-height: 50px;\n}\n\nion-menu.ios ion-item.selected ion-icon {\n  color: var(--ion-color-danger);\n}\n\nion-menu.ios ion-item ion-icon {\n  font-size: 24px;\n  color: black;\n}\n\nion-menu.ios ion-list#labels-list ion-list-header {\n  margin-bottom: 8px;\n}\n\nion-menu.ios ion-list-header,\nion-menu.ios ion-note {\n  padding-left: 16px;\n  padding-right: 16px;\n}\n\nion-menu.ios ion-note {\n  margin-bottom: 8px;\n}\n\nion-note {\n  display: inline-block;\n  font-size: 16px;\n  color: black;\n}\n\nion-item.selected {\n  color: black;\n}\n\nion-toolbar {\n  --ion-background-color: #2D6082;\n  color: white;\n}\n\n.container-imagen {\n  background-color: #34495E;\n  height: 15em;\n  margin-bottom: 2em;\n  box-shadow: inset 0 -2em 6em #aed6f1, -2em 1em 0 2px white, 0.3em 0.3em 1em #d6eaf8;\n}\n\nion-icon {\n  color: #DC7633;\n}\n\n.container-actividades {\n  color: #DC7633;\n  font-family: \"Courier New\", Courier, monospace;\n}\n\n.hover:hover {\n  background-color: #ff2121;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, menu, navController, alertCtrl, authservice) {
...
let DetailSubeventPage = class DetailSubeventPage {
    constructor(route, eventoService, alertCtrl, authservice, beaconService) {
        this.route = route;
...
let MoreinformationPage = class MoreinformationPage {
    constructor(authService, eventoService, route, auth, alertCtrl, beaconService) {
        this.authService = authService;
        this.eventoService = eventoService;
        this.route = route;
        this.auth = auth;
